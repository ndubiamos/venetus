	...
	return (
		<div className={styles.settings}>
			...
			<div className={styles.all}>
				...
				<a href="https://github.com/alyssaxuu/ecosnap" target="_blank" className={styles.item}><span>About us</span> <img src="enter.svg"/></a>
				<a href="https://github.com/alyssaxuu/ecosnap#credit" target="_blank" className={styles.item}><span>Credit</span> <img src="enter.svg"/></a>
				<div className={styles.space}></div>
